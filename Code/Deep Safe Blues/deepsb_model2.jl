...
Isb   = Array(strand_data[2:end,1:training_end])
Itrue = Array(strand_data[1,1:training_end])
Isb_extrap   = Array(strand_data[2:end,:])
...
scatter(0:150,Itrue_extrap[1:151],color=:red, legend = :topright, ylims = (0.0,0.2), ylabel = "Proportion Infected", xlabel="Day",label="Infected")
scatter!(151:170,Itrue_extrap[152:171],color=:orange,label="True Unknown Proportion Infected")
plot!(0:150,ann(Isb_extrap)'[1:151],color=3,lw=4,label="Predicted Infected: Trained on Current Numbers")
plot!(150:170,ann(Isb_extrap)'[151:171],color=1,lw=4,label="Safe Blues Projected Infected")
#plot!(0:365,sol_nosb2[2,1:366]./10^5,lw=3,label="Predicted Infected: SIR No SafeBlues")
...
plot!(0:170,Isb_extrap'[1:171,:],alpha=0.10,color=:blue,label=false)
