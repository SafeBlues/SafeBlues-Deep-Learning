...
datafile = "Model-III-low-dataset"
strand_data = CSV.read("$datafile.csv",header=false)
policydatafile = "Model-III-low-ld-parameters"
...
plot!(fulltime,Isb_extrap',alpha=0.25,label=false)
...
scatter(0:365,Itrue_extrap,color=:red,title="SafeBlues vs No SafeBlues 2nd Peak Detection: Model 3", legend = :topleft, ylabel = "Percentage Infected", xlabel="Day",label=" Infected")
...
scatter(0:100,Itrue_extrap[1:101],color=:red,title="SafeBlues vs No SafeBlues 2nd Peak Detection: Model III", legend = :topleft, ylabel = "Proportion Infected", xlabel="Day",label="Infected")
scatter!(101:120,Itrue_extrap[102:121],color=:orange,label="True Unknown Proportion Infected")

plot!(101:120,ann(Isb_extrap)'[102:121],color=1,lw=4,label="Safe Blues Projected Infected")
plot!(0:100,ann(Isb_extrap)'[1:101],color=3,lw=4,label="Predicted Infected: Trained on Current Numbers")
...
plot!(0:120,Isb_extrap'[1:121,:],alpha=0.10,color=:blue,label=false)
